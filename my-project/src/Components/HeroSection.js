...
const HeroSection = () => {
    return (
        <div>
            <div className='flex flex-col gap-10 m-10 my-14 items-center justify-center lg:m-20 lg:mt-16 md:m-16'>

              <h1 className=' text-3xl font-semibold  text-[#F58E22] md:text-3xl lg:text-5xl'>WELCOME TO AL SAHEL AL SAREEHA</h1> 
              

                <div className='flex flex-col justify-start items-start'>
                    <HPcomponent heading={"OUR STORY"} paragraph={"In the heart of the UAE's vibrant business scene, we are a dynamic team of young and tech-savvy entrepreneurs. Specializing in logistics and custom clearance, we are committed to enhancing business growth through streamlined supply chain management. Our focus on innovation and expertise ensures that we deliver precise solutions for the evolving needs of businesses in the region."} />
